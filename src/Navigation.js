...
function Navigation(location, history) {
  ...
  return (
    ...
    >
        <SideNav.Toggle />
        <SideNav.Nav defaultSelected="kitchen"> {/*className="sidenavbottom"*/}
            <NavItem eventKey="kitchen">
                <NavIcon>
            ...
            {/* <SideNav.Nav className="sidenavbottom"> */}
