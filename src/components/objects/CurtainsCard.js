                    ...
                    <Card.Header>
                        <Form.Group as={Row}>
                            ...
                            <Col xs={2} sm={2} md={4} lg={4}>
                                <InputGroup.Append>
                                    <InputGroup.Text id="basic-addon2" className="cardAddon">{this.props.curtainsValue}%</InputGroup.Text>
                                </InputGroup.Append>
                            </Col>
                        </Form.Group>
                    </Card.Header>
